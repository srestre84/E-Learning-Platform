...
/**
 * Servicio para migrar datos de H2 a PostgreSQL en producción
 * Solo se ejecuta en perfil de producción
 */
@Service
@Profile("prod")
...
public class DataMigrationService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        log.info("Iniciando migración de datos para producción...");
        
        // Solo crear datos si no existen
        if (userRepository.count() == 0) {
            createProductionData();
        } else {
            log.info("Datos ya existen en producción, saltando migración");
        }
    }

    private void createProductionData() {
        log.info("Creando datos de producción...");
        ...
        log.info("Datos de producción creados exitosamente");
    }
