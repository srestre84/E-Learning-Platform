...
const TeacherRoute = ({ children }) => {
        ...
        <div className="text-center space-y-4 max-w-md">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-500">
              Estamos validando tus permisos de profesor...
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-gray-500">
                {authError.message || "No se pudo verificar tu sesión."}
              </p>
            </div>
  ...
  const isTeacher =
    normalizedRole === "teacher" || normalizedRole === "instructor";

  if (!isTeacher) {
    console.warn(
      `Acceso denegado: Usuario con rol ${user?.role} intentó acceder a una ruta de profesor`
    );
